...
| --- | --- | :-: | :-: | :-: |
| 寸法 | rest pose / bone 長 | ✅ | ✅ | ✅ |
| 位置 ROM | per-joint position limit | ✅ (13) | ✅ (11) | ✅ (13) |
| 速度 | per-joint velocity limit | ✅ (13) | ✅ (11) | ✅ (13) |
| トルク | per-joint effort limit | ✅ (13) | ✅ (11) | ✅ (13) |
| 質量分布 | per-link mass → bone | ✅ | ✅ | ✅ |
| 慣性 | per-bone inertia tensor | ✅ (14) | ✅ (14) | ✅ (15) |
| balance | 実フットプリント / COM | ✅ | ✅ | ✅ |

括弧内は実値を持つ canonical 関節 / bone の数（残りは合成 toe 等の placeholder/floor）。
...
- **Unitree G1 / H1**: robot descriptions © HangZhou YuShu TECHNOLOGY CO.,LTD. ("Unitree Robotics"),
