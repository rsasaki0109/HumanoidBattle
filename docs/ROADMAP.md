...
- [x] seed dataset adapters: **AMASS (skeleton-first, SMPL FK)** ✅。AIST++ / HumanML3D / BABEL は今後
...
- [ ] 学習 motion encoder（masked motion modeling / contrastive video-text-motion）で v0 を差し替え
- [ ] motion tokenizer / VQ-VAE、motion foundation model baseline、RL tracking baseline
